                    ...
                    <tr>
                        ...
                        <td class="tw-flex tw-flex-row">
                            ...
                            <a class="btn btn-sm btn-info bg-primary tw-h-[1.65rem]" href="{{route('users.show',$student)}}" role="button">
                              ...
                              <a class="btn btn-sm btn-warning bg-secondary border-secondary tw-h-[1.65rem]" href="{{route('users.edit',$student)}}" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
